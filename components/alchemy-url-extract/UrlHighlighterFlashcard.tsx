...
interface UrlHighlighterFlashcardProps {
    urlData: any;
}

const UrlHighlighterFlashcard: React.FC<UrlHighlighterFlashcardProps> = ({ urlData }) => {
    ...
    const handleSaveFlashcard = async () => {
        ...
        try {
            const response = await fetch('/api/flashcardsets', {
                ...
                body: JSON.stringify({
                    title: `Flashcard từ URL: ${urlData.title}`,
                    description: 'Tạo tự động từ Trích xuất URL',
                    sourceNoteId: urlData._id,
                    cards: [
                        {
                    ...
                    tags: ['url-extract', 'auto-generated']
                })
            });
    ...
    return (
        <div className="relative h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
                <UrlReader urlData={urlData} contentRef={contentRef} />
            </div>
...
export default UrlHighlighterFlashcard;
